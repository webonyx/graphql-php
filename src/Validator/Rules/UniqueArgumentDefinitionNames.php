...
class UniqueArgumentDefinitionNames extends ValidationRule
{
    public function getSDLVisitor(SDLValidationContext $context): array
    {
        ...
        return [
            NodeKind::DIRECTIVE_DEFINITION => static function (DirectiveDefinitionNode $node) use ($context) {
                return self::checkArgUniqueness('@' . $node->name->value, $node->arguments, $context);
            },
